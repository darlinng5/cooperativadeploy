...
class Usuarios extends Component {
  ...
  render() {
    ...
    const itemsFilter = items.filter(item => item.identidadUsuario.startsWith(buscarUsuario));
    if (!isLoaded) {
                  ...
                  {itemsFilter.map((item) => (
                    <TableRow key={item.identidadUsuario}>
                      ...
                      <TableCell align="right">
                        <IconButton aria-label="Delete" onClick={() => this.onClickDelete(item.identidadUsuario)}  >
                          < DeleteIcon />
                        </IconButton>
                        <Link to={{ pathname: "/editarusuarios", state: { item } }}>
                          <IconButton aria-label="Update" >
                            <EditIcon />
                          </IconButton>
                        </Link>
                        <Link to={{ pathname: "/infousuarios", state: { item } }}>
